...
public class Var108005Result {
    ...
    private List<Var108005InfoBean> result;
	...
	public List<Var108005InfoBean> getResult() {
		return result;
	}
	public void setResult(List<Var108005InfoBean> result) {
		this.result = result;
	}
