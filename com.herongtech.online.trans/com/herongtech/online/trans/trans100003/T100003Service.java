 ...
 * 修改记录: 修改日期    修改人员    修改说明
 *********************************************/
package com.herongtech.online.trans.trans100003;
 ...
 *
 */
public class T100003Service extends OnlineBaseService {
	/**
	 * 入口方法
	 * @param context
	 */
	protected void action(Context context) throws Exception {
		Var100003 transVar = new Var100003();
	 ...
	 */
	protected void CheckData(Context context, Var100003 transVar) throws BizAppException{
	 ...
	 * @throws BizAppException
	 */
    protected void ToLocal(Context context, Var100003 transVar) throws BizAppException {
     ...
     * @throws BizAppException
     */
    protected void PackAnswer(Context context, Var100003 TransVar) throws BizAppException{
    	IData request = (IData)ContextUtil.getRequestData(context);
