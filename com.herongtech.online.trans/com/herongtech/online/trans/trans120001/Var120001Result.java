...
public class Var120001Result {
    ...
    private List<Var120001InfoBean> result;
	...
	public void setResult(List<Var120001InfoBean> result) {
		this.result = result;
	}

	public List<Var120001InfoBean> getResult() {
		return result;
	}
