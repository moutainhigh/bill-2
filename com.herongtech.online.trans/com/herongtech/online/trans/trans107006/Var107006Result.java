...
public class Var107006Result {
    ...
    private List<Var107006InfoBean> result;
	...
	public List<Var107006InfoBean> getResult() {
		return result;
	}
	public void setResult(List<Var107006InfoBean> result) {
		this.result = result;
	}
