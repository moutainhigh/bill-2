 ...
 * 可撤消存票票据查询
 */
public class T120002Service extends OnlineBaseService {
	...
	protected void action(Context context) throws Exception {
		VarT120002 transVar = new VarT120002();
	 ...
	 */
	protected void CheckData(Context context, VarT120002 var120002) throws BizAppException{
		String request = (String)ContextUtil.getRequestData(context);
		Map<String, Class> clazzMap = new HashMap<String, Class>();
		clazzMap.put("Document", VarT120002.class);
		VarT120002 temp=(VarT120002)XmlBeanUtil.xml2Bean(clazzMap, request);
		if (StringUtils.isEmpty(temp.getCustAccount())){
			throw new BizAppException(IErrorNo.ERR_CUSTACCOUNTNULL, "客户账号未上送");
		}
		BeanUtils.copyProperties(temp, var120002);
	}
	 ...
	 * @throws BizAppException
	 */
    protected void ToLocal(Context context, VarT120002 var120002) throws BizAppException{
    	RcBaseSearchBean searchBean=new RcBaseSearchBean();
        searchBean.setHoldAcctNo(var120002.getCustAccount());
        searchBean.setBillClass(IDict.K_BILL_CLASS.K_ELEC_BILL);
        Page page = null;
        List<Var120002InfoBean> result =new ArrayList<Var120002InfoBean>();
		...
		try {
			rgctBill = session.getBeanListByListForPage(
					sql,
					RgctBill.class,
					Integer.valueOf(var120002.getCurrentPage()),
					Integer.valueOf(var120002.getPageSize()),
					list);
			var120002.setTotalRows(Integer.toString(session.account("select count(*) from ("+sql+")")));
		...
		if(rgctBill.size() <= 0){
    		...
    		for (RgctBill rgctBillList:rgctBill) {
    			Var120002InfoBean bean=new Var120002InfoBean();
     ...
     * @throws BizAppException
     */
    protected void PackAnswer(Context context, VarT120002 var120002) throws BizAppException{
        ...
        List<Var120002InfoBean> infoList=var120002.getResult();
        Var120002Result result=new Var120002Result();
        result.setProResult(proResult);
        result.setResult(infoList);
        
        Map<String, Class> clazzMap = new HashMap<String, Class>();
        clazzMap.put("Document", Var120002Result.class);
        clazzMap.put("info", Var120002InfoBean.class);
