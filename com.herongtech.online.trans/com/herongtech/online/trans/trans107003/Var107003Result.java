package com.herongtech.online.trans.trans107003;
...
public class Var107003Result {
    ...
    private List<Var107003InfoBean> result;
	...
	public List<Var107003InfoBean> getResult() {
		return result;
	}
	public void setResult(List<Var107003InfoBean> result) {
		this.result = result;
	}
