...
public class CreditChannelService {

    private static Logger logger = LoggerFactory.getLogger(CreditChannelService.class);
     ...
     * xml客户端
     */
    private CreditClient client = null;
    ...
    public void init(XmlNode config) {
        ...
        client.setCreditSwitch(SysConfigUtil.getSysConfig().getValue("creditSwitch"));
    }
