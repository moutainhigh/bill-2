<%-- 
 * 文件名称: buyback_audit_batch_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
	...
	<div class="clearfix">
		<div id="page-content" class="page-content">
							...
							<c:when test="${not empty batchList}">
								<c:forEach items="${batchList}" var="batch" varStatus="vs">
									<tr>
										...
										<td class="center"><a class="" href="javascript:goBatchInfo('${batch.buybackId}');">查看</a></td>
									</tr>
								</c:forEach>
							</c:when>
							<c:otherwise>
			...
			<div id="page" class="pagination">
				<form action="<%=basePath%>buybackAuditController.do?method=auditBatchList"  name="pageForm" method="post">
...
<script>
		function auditDetailList(){
			...
			pageForm.action = "<%=basePath%>buybackAuditController.do?method=auditDetailList";
			pageForm.submit();
		}
</script>
</body>
