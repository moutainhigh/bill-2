		...
		<div id="page-content" class="page-content">
			...
			<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>buybackAuditController.do?method=entityAuditBatchList" method="post" name="pageForm">
...
<script>
	...
	function billManage(){
		...
		pageForm.action = "<%=basePath%>buybackAuditController.do?method=entityAuditBillList";
		pageForm.submit();
	}
	//批次详情页面
