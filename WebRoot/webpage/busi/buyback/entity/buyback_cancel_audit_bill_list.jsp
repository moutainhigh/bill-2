<%-- 
 * 文件名称:buyback_cancel_audit_bill_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
		...
		<div id="page-content" class="page-content">
			...
			<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>buybackAuditController.do?method=cancelAuditBillList" method="post" name="pageForm">
...
<script>
	...
	function cancelAudit(){
		...
		Form.action = "<%=basePath%>buybackAuditController.do?method=entityCancelAudit";
		Form.submit();
	}
	//返回
	function goHistory(){
		modal("#layer_loading,#image");//点击票据管理按钮，弹出‘加载中’的遮罩层
		Form.action = "<%=basePath%>buybackAuditController.do?method=cancelAuditBatchList";
		Form.submit();
	}
	//详情页面
