<%-- 
 * 文件名称:buyback_cancel_apply_bill_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
		...
		<div id="page-content" class="page-content">
			...
			<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>buybackApplyController.do?method=cancelApplyBillList" method="post" name="pageForm">
...
<script>
	...
	function cancelApply(){
		...
		Form.action = "<%=basePath%>buybackApplyController.do?method=entityCancelApply";
		Form.submit();
	}
	//返回
	function goHistory(){
		modal("#layer_loading,#image");//点击票据管理按钮，弹出‘加载中’的遮罩层
		Form.action = "<%=basePath%>buybackApplyController.do?method=cancelApplyBatchList";
		Form.submit();
	}
	//详情页面
