<%-- 
 * 文件名称: rebuy_apply_submit_elec_outer.jsp
 * 系统名称: 票据管理平台
 * 模块名称: 电票转入申请提交页面
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
				<form action="<%=basePath%>rebuyApplyController.do?method=applySubmitElec" method="post" name="batchForm" id="batchForm" class="form-search detail-form">
				...
				<form  id="btnForm">
					<div class="row-fluid">
						<div class="span6" id="btn-left">
							...
							<a class="btn-mini" onclick="printPZ();">凭证打印</a>
		...
		<div>
			<div id="page" class="pagination">
				<form action="<%=basePath%>rebuyApplyController.do?method=toSubmitPage" method="post" name="pageForm">
...
<script>
	...
	function calculateInterest(){
		...
		var diag = new top.Dialog();
		 diag.Drag = true;
		 diag.Title ="利息试算";
		 diag.URL = "<%=basePath%>rebuyApplyController.do?method=toCalculateInterestElecPage&ids="+ids;
		 diag.Width = 540;
		 diag.Height = 200;
		 diag.CancelEvent = function(){ //关闭事件
			pageForm.submit();
