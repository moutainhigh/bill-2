<%-- 
 * 文件名称: reoke_rebuy_audit_bill_elec.jsp
 * 系统名称: 票据管理平台
 * 模块名称: 电票转入撤销审核清单列表页面
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
		...
		<div id="page-content" class="page-content">
			...
			<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>rebuyAuditController.do?method=elecsearchRevokableDetail"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
		...
		dataCollectForm.action = "<%=basePath%>rebuyAuditController.do?method=searchRevokableAuditBatchElec";
	...
	function revokeAudit(){
		...
		dataCollectForm.action = "<%=basePath%>rebuyAuditController.do?method=elecrevokeAudit";
		dataCollectForm.submit();
	}
</script>
</body>
