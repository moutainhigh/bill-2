<%-- 
 * 文件名称: rebuy_audit_batch_elec.jsp
 * 系统名称: 票据管理平台
 * 模块名称: 电票转入审核批次页面
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
			...
			<form  action="#" name="dataCollectForm" method="post"></form>
			 ...
			 <div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>rebuyAuditController.do?method=listAuditElec"  name="pageForm" method="post">
...
<script>
	function auditDetailList(rebuyId){
		...
		dataCollectForm.action = "<%=basePath%>rebuyAuditController.do?method=elecauditDetailList";
