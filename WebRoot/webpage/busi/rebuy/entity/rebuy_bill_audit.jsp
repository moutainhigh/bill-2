...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			...
			<%-- 按钮操作区 --%>
			<div id="center">
				<form  id="btnForm" method="post" action="rebuyAuditController.do?method=auditDetailList">
					<div class="row-fluid">
			...
			<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>rebuyAuditController.do?method=auditDetailList"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
		...
		dataCollectForm.action = "<%=basePath%>rebuyAuditController.do?method=listAuditEntity";
