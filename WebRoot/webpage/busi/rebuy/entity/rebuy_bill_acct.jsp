...
<script>
	...
	function goHistory(){
		...
		dataCollectForm.action = "<%=basePath%>rebuyAccountController.do?method=listAccountEntity";
	...
	function submit(ids,rebuyId){
		...
		dataCollectForm.action = "<%=basePath%>rebuyAccountController.do?method=accountSubmit";
		modal("#layer_loading,#image");
		dataCollectForm.submit();
	}
	//打印转贴现记账清单
