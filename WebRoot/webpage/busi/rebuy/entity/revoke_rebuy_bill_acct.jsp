<%-- 
 * 文件名称: revoke_rebuy_bill_acct.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
		...
		<div id="page-content" class="page-content">
				...
				<form  id="btnForm">
					<div class="row-fluid">
						...
						<div class="span6" id="btn-right">
							<a class="btn-mini pull-right" href="javascript:revokeAccount();">撤销记账</a>
			...
			<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>rebuyAccountController.do?method=searchRevokableDetail"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
		...
		dataCollectForm.action = "<%=basePath%>rebuyAccountController.do?method=searchRevokableBatch";
	...
	function goDetail(rebuymxId){
		 ...
		 diag.Drag = true;
		 diag.Title ="详情";
		 diag.URL = '<%=basePath%>rebuyApplyController.do?method=goDetail&rebuymxId='+rebuymxId;
		 diag.Width = 920;
		 diag.Height = 450;
	...
	function revokeAccount(){
		...
		dataCollectForm.action = "<%=basePath%>rebuyAccountController.do?method=revokeAccount";
		dataCollectForm.submit();
	}
</script>
</body>
