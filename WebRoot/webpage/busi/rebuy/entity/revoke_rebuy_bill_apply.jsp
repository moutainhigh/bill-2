<%-- 
 * 文件名称: revoke_rebuy_bill_apply.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
				...
				<form  id="btnForm">
					<div class="row-fluid">
						...
						<div class="span6" id="btn-right">
							<a class="btn-mini pull-right" href="javascript:revokeApply('${batch.rebuyId}');">撤销申请</a>
...
<script>
	...
	function goHistory(){
		...
		dataCollectForm.action = "<%=basePath%>rebuyApplyController.do?method=searchRevokableBatch";
	...
	function revokeApply(){
		...
		dataCollectForm.action = "<%=basePath%>rebuyApplyController.do?method=revokeApply";
		dataCollectForm.submit();
	}
</script>
</body>
