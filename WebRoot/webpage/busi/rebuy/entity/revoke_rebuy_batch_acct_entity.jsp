<%-- 
 * 文件名称: revoke_rebuy_batch_acct_entity.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
			...
			<div id="center">
				<div class="row-fluid">
					<div class="span6" id="btn-left" >
						<a class="btn-mini" href="javascript:searchRevokableDetail();">下一步</a>
					</div>
		    ...
		    <div id="footer">
			 ...
			 <div>
			 	<div id="page" class="pagination">
					<form action="<%=basePath%>rebuyAcctController.do?method=searchRevokableBatch"  name="pageForm" method="post">
...
<script>
	function searchRevokableDetail(rebuyId){
		var checkNum = getCheckNum("rebuyId");
		if (checkNum ==0){
			bootbox.alert("请选择要撤销记账的记录");
			return;
		}
		if (checkNum !=1){
			bootbox.alert("一次只能对一个批次进行撤销记账");
			return;
		}
		modal("#layer_loading,#image");
		var rebuyId = getCheckStr("rebuyId");	
		dynamicHiddenElement('dataCollectForm','rebuyId',rebuyId);
		dataCollectForm.action = "<%=basePath%>rebuyAccountController.do?method=searchRevokableDetail";
