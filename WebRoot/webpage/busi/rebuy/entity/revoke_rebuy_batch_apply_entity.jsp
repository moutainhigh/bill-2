<%-- 
 * 文件名称: revoke_rebuy_batch_apply_entity.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
		    ...
		    <div id="footer">
			 ...
			 <div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>rebuyApplyController.do?method=searchRevokableBatch"  name="pageForm" method="post">
...
<script>
	function searchRevokableDetail(rebuyId){
		...
		dataCollectForm.action = "<%=basePath%>rebuyApplyController.do?method=searchRevokableDetail";
