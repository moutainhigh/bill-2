<%-- 
 * 文件名称: disc_elec_cancel_apply_batch_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
...
<body style="font-family:'微软雅黑';">
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
				<form action="<%=basePath%>discApplyController.do?method=cancelElecBatch" method="post" id="page-content" name="searchForm" style="padding:0px;" class="form-search">
				<%-- 查询区  --%>
					<div class="row-fluid">
	...
	<%-- /列表操作区 --%>
		<div id="page" class="pagination">
			<form action="<%=basePath%>discApplyController.do?method=cancelElecBatch"  name="pageForm" method="post">
...
<script>
		...
		function cancelList(){
			...
			location.href="<%=basePath%>discApplyController.do?method=cancelBillList&discId="+discId;
		}
			//详情页面
