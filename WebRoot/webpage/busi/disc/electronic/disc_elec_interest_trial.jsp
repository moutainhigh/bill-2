<%-- 
 * 文件名称: disc_elec_interest_trial.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 利息试算
...
<body>
	<div class="clearfix">
		<div class="page-content" id="jump-content">
			<form action="<%=basePath%>discApplyController.do?method=elecInterestTrial" name="Form" id="Form"
				...
				<div class="row-fluid" >
					...
					<t:dictSelect valid="required" className="select-medium" name="isSameCity" other="" dictGroup="K_ISSAMECITY" haveHead="true" title="请选择同城异地" >
					</t:dictSelect>
					<input type="hidden" name="isSameCity" value="1"/>
				</div>
				<div class="row-fluid" >
					<label for="delayType" class="text-right"><span class="star">*</span>请选择顺延规则</label>
					<t:dictSelect valid="required" className="select-medium" name="delayType" other="" dictGroup="K_ELEC_DELAYTYPE" haveHead="true" title="顺延规则" defaultVal="0">
					</t:dictSelect>
				</div>
