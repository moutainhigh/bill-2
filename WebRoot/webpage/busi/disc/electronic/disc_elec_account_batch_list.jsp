<%-- 
 * 文件名称: disc_elec_account_batch_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
				<form action="<%=basePath%>discAccountController.do?method=finalAccount" method="post" id="page-content" name="searchForm" class="form-search">
					<%-- 查询区  --%>
			...
			<div id="page" class="pagination">
				<form action="<%=basePath%>discAccountController.do?method=finalAccount"  name="pageForm" method="post">
...
<script>
	...
	function accountList(){
		...
		location.href="<%=basePath%>discAccountController.do?method=elecAccountBillList&discId="+discId;
	}
	//详情页面
