...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
				<form action="<%=basePath%>subcollApplyController.do?method=batchManage"  method="post" name="infoForm" id="infoForm" class="form-search">
				</form>
				<%-- 按钮操作区 --%>
				<div id="center">
					<form  id="btnForm">
			...
			<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>subcollApplyController.do?method=batchManage"  name="pageForm" method="post">
...
<script>
	...
	function billManage(){
		...
		dataCollectForm.action = "<%=basePath%>subcollApplyController.do?method=editBillManage";
