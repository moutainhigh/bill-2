<%-- 
 * 文件名称: revoke_send_batch_manage.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 批次列表页面
...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="center">
				<form action="<%=basePath%>subcollStorageController.do?method=revokeSendBatchManage"  method="post" name="infoForm" id="infoForm" class="form-search">
					<%-- 按钮操作区 --%>
					<div class="row-fluid">
		     ...
		     <div id="footer">
									...
									<c:forEach items="${batchList}" var="subcollApplyInfo" varStatus="vs">
										<tr>
											<td class="center" style="width: 30px;">
												<label><input type='checkbox' name='subcollId' value="${subcollApplyInfo.subcollId}" /><span class="lbl"></span></label>
											</td>
				...
				<div>
					<div id="page" class="pagination">
						<form action="<%=basePath%>subcollStorageController.do?method=revokeSendBatchManage"  name="pageForm" method="post">
...
<script>
	...
	function billManage(){
		...
		dataCollectForm.action = "<%=basePath%>subcollStorageController.do?method=revokeSendBillDetail";
