...
<div id="page-content" class="page-content">
	...
	<%-- button --%>
<div id="center">
<form action="<%=basePath%>receiveMoneyController.do?method=elecRevokeBillRegister"  method="post" id="" name="custForm" style="margin-bottom:0px;" class="form-search">
	<div id="formDiv" class="f-filter row-fluid" style="margin-bottom:0px;margin-left:0px;">
		<div class="but_sytle span6" id="btn-left">
			<%-- <a class="btn-mini" onclick="revokeBill();">退票</a> --%>
	...
	<div>
		<div id="page" class="pagination">
			<form action="<%=basePath%>receiveMoneyController.do?method=elecRevokeBillRegister"  name="pageForm" method="post">
