...
<div id="center">
	<form action="<%=basePath%>subcollStorageController.do?method=elecRevokeSendBatchManage"  method="post" name="infoForm" id="infoForm" class="form-search">
<%-- 按钮操作区 --%>
		<div class="row-fluid">
	...
	<div>
		<div id="page" class="pagination">
			<form action="<%=basePath%>subcollStorageController.do?method=elecRevokeSendBatchManage"  name="pageForm" method="post">
