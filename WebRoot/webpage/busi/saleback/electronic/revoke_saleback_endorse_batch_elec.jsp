<%--
 * 文件名称: reovke_saleback_endorse_batch_elec.jsp
 * 系统名称: 票据管理平台
 * 模块名称: 电票转入撤销申请批次列表页面
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
			...
			<form  action="#" name="dataCollectForm" method="post"></form>
			 ...
			 <div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>SalebackApplyController.do?method=searchEndorseRevokableSalebackBatch"  name="pageForm" method="post">
...
<script>
	...
	var checkNum = getCheckNum("rebuyId");
		...
		dataCollectForm.action = "<%=basePath%>SalebackApplyController.do?method=searchsalebackcxendorselistElec";
