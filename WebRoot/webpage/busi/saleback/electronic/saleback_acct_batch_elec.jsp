<%--
 * 文件名称: saleback_acct_batch_elec.jsp
 * 系统名称: 票据管理平台
 * 模块名称: 电票转入撤销申请批次列表页面
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
			...
			<form  action="#" name="dataCollectForm" method="post"></form>
			 ...
			 <div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>salebackAccountController.do?method=searchAccountableSalebackBatch"  name="pageForm" method="post">
...
<script>
	function nextStep(){
		...
		dataCollectForm.action = "<%=basePath%>salebackAccountController.do?method=searchSaleBackAccountBillList";
