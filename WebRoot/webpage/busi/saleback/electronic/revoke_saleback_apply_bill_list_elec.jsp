	...
	<div class="clearfix">
		<div id="page-content" class="page-content">
			...
			<div id="page" class="pagination">
				<form action="<%=basePath%>SalebackApplyController.do?method=searchsalebacklistElec" name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
		...
		dataCollectForm.action = "<%=basePath%>SalebackApplyController.do?method=searchApplyRevokableSalebackBatch";
	...
	function apply(){
		...
		dataCollectForm.action = "<%=basePath%>SalebackApplyController.do?method=revokesalebackapply";
		dataCollectForm.submit();
	}
	//详情页面
