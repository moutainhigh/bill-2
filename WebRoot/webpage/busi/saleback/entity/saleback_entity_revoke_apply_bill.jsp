	...
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
				<form action=""	method="post" name="infoForm" id="infoForm" class="form-search disEleOuter">
					...
					<div class="row-fluid threeLine">
						...
						<input type="text" class="input-medium input-date" name="createDt" readonly id="createDt" value="${batch.createDt}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});"/>
					</div>
				...
				<form id="btnForm">
					<div class="row-fluid">
						...
						<div class="span6" id="btn-right">
							<a class="btn-mini pull-right" onclick="apply();">撤销</a>
			...
			<div id="page" class="pagination">
				<form action="<%=basePath%>SalebackApplyController.do?method=searchsalebacklistEntity" name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
		...
		dataCollectForm.action = "<%=basePath%>SalebackApplyController.do?method=entityApplyRevokableSalebackBatch";
	...
	function apply(){
		...
		dataCollectForm.action = "<%=basePath%>SalebackApplyController.do?method=revokeapplysubmit";
		dataCollectForm.submit();
	}
	//详情页面
