			...
			<form  action="#" name="dataCollectForm" method="post"></form>
			 ...
			 <div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>SalebackApplyController.do?method=entityApplyRevokableSalebackBatch"  name="pageForm" method="post">
...
<script>
	...
	var checkNum = getCheckNum("rebuyId");
		...
		dataCollectForm.action = "<%=basePath%>SalebackApplyController.do?method=searchsalebacklistEntity";
