<%--
 * 文件名称: saleback_entity_account_batch.jsp
 * 系统名称: 票据管理平台
 * 模块名称: 纸票返售记账批次页面
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
			...
			<form  action="#" name="dataCollectForm" method="post"></form>
			 ...
			 <div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>salebackAccountController.do?method=entitySalebackaccountBatch"  name="pageForm" method="post">
...
<script>
	...
	var checkNum = getCheckNum("rebuyId");
		...
		dataCollectForm.action = "<%=basePath%>salebackAccountController.do?method=entitySalebackaccountbill";
