...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
			    <form action="<%=basePath%>intoAuditController.do?method=auditBatchList" method="post" id="page-content" name="Form" style="padding:0px;" class="form-search">
					<%-- 查询区  --%>
					<div class="row-fluid">
    		...
    		<div id="footer">
				...
				<div>
					<div id="page" class="pagination">
						<form action="<%=basePath%>intoAuditController.do?method=auditBatchList"  name="pageForm" method="post">
...
<script>
	...
	function seachWaitAuditBill(){
	     ...
	     dataCollectForm.action = "<%=basePath%>intoAuditController.do?method=auditBillList"
