...
<html>
  <head>
	...
	<style>
		#page-content .detail-form .row-fluid label{width:90px;}
	</style>
</head>
<body>
	<div class="clearfix">
		...
		<div>
			<div id="page" class="pagination">
					<form action="<%=basePath%>intoAuditController.do?method=auditBillList"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
        ...
        dataCollectForm.action="<%=basePath%>intoAuditController.do?method=auditBatchList";
	...
	function audit(){
		...
		var intoId = '${batch.intoId}';
		 ...
		 diag.Drag = true;
		 diag.Title ="审核";
		 diag.URL = "<%=basePath%>intoAuditController.do?method=toAudit&ids="+ids+"&intoId="+intoId;
		 diag.Width = 430;
		 diag.Height =180;
