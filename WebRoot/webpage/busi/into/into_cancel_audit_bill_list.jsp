	...
	<div class="clearfix">
		...
		<div>
			<div id="page" class="pagination">
					<form action="<%=basePath%>intoAuditController.do?method=cancelAuditBillList"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
        ...
        dataCollectForm.action="<%=basePath%>intoAuditController.do?method=cancelAuditBatchList";
	...
	function cancelAudit(){
		...
		modal("#layer_loading,#image");//点击票据管理按钮，弹出‘加载中’的遮罩层
		$.ajax({
			url:"<%=basePath%>intoAuditController.do?method=cancelAudit",
			type:"POST",
			data:{"ids":ids},
			dataType:"json",
			success:function(rs){
