<%-- 
 * 文件名称: collate_elec_cancel_audit_batch_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
			    <form action="<%=basePath%>intoAuditController.do?method=elecCancelAuditBatchList" method="post" id="page-content" name="Form" style="padding:0px;" class="form-search">
				<%-- 查询区  --%>
				<div class="row-fluid">
				...
				<table class="table table-striped table-bordered table-hover" id="tab" cellpadding="0" cellspacing="0">
				 ...
				 <div>
					<div id="page" class="pagination">
							<form action="<%=basePath%>intoAuditController.do?method=elecCancelAuditBatchList"  name="pageForm" method="post">
...
<script>
	...
	function cancelAudit(){
	     ...
	     dataCollectForm.action = "<%=basePath%>intoAuditController.do?method=elecCancelAuditBillList"
