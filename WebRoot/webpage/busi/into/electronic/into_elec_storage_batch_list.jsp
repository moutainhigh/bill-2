<%-- 
 * 文件名称: collate_elec_storage_batch_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
			    <form action="<%=basePath%>intoStorageController.do?method=elecStorageBatchList"  method="post" id="page-content" name="Form" style="padding:0px;" class="form-search">
				<%-- 查询区  --%>
				<div class="row-fluid">
	       ...
	       <div id="footer">
				...
				<div>
					<div id="page" class="pagination">
							<form action="<%=basePath%>intoStorageController.do?method=elecStorageBatchList"  name="pageForm" method="post">
...
<script>
	...
	function seachWaitStorageBill(){
	     ...
	     dataCollectForm.action = "<%=basePath%>intoStorageController.do?method=elecStorageBillList"
