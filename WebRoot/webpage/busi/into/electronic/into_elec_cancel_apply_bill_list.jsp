		...
		<div id="page-content" class="page-content">
			...
			<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>intoApplyController.do?method=elecCancelApplyBillList"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
        ...
        dataCollectForm.action="<%=basePath%>intoApplyController.do?method=elecCancelApplyBatchList";
	...
	function cancelApply(){
		...
		$.ajax({
			url:"<%=basePath%>intoApplyController.do?method=elecCancelApply",
			type:"POST",
			data:{"ids":ids,"intoId":intoId},
			dataType:"json",
			success:function(rs){
				if(rs.success){
					dataCollectForm.action = "<%=basePath%>intoApplyController.do?method=elecCancelApplyBatchList";
