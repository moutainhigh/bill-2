...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
			    <form action="<%=basePath%>intoAuditController.do?method=cancelAuditBatchList" method="post" id="page-content" name="Form" style="padding:0px;" class="form-search">
				<%-- 查询区  --%>
				<div class="row-fluid">
				...
				<form action="#" name="dataCollectForm" method="post"></form>
				 ...
				 <div>
					<div id="page" class="pagination">
							<form action="<%=basePath%>intoAuditController.do?method=cancelAuditBatchList"  name="pageForm" method="post">
...
<script>
	...
	function cancelAudit(){
	     ...
	     dataCollectForm.action = "<%=basePath%>intoAuditController.do?method=cancelAuditBillList"
