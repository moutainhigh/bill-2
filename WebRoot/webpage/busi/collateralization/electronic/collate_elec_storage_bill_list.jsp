<%-- 
 * 文件名称: collate_elec_storage_bill_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
	...
	<div class="clearfix">
		...
		<div>
			<div id="page" class="pagination">
					<form action="<%=basePath%>collateralizationStorageController.do?method=elecStorageBillList"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
        ...
        dataCollectForm.action="<%=basePath%>collateralizationStorageController.do?method=elecStorageBatchList";
		...
		var checkNum = getCheckNum("ids");
	   	...
	   	bootbox.confirm("确定要入库选中的记录吗?", function(result) {
			if(result) {
				...
				$.ajax({
					type: "POST",
					url: '<%=basePath%>collateralizationStorageController.do?method=elecStorage',
