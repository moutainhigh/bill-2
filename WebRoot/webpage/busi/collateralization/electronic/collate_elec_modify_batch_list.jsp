...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
				<form action="<%=basePath%>collateralizationApplyController.do?method=elecModifyApplyBatchList"  method="post" name=userForm id="userForm" class="form-search">
					<%-- 查询区  --%>
					<div class="row-fluid">
						<label class="no-padding-right" for="batchNo">批次号</label>
						<input type="text" class="input-medium" id="batchNo" name="batchNo" value="${batchNo}" placeholder="请输入批次号"/>
						<a class="btn-mini" id="search" onclick="search();">查询</a>
					</div>
				</form>
			</div>
			<%-- 按钮操作区 --%>
			<div id="center">
				<form action="<%=basePath%>collateralizationApplyController.do?method=elecModifyApplyBatchList"  method="post" id="page-content" name="custForm" style="padding:0px;" class="form-search">
					<div class="row-fluid">
    	...
    	<div id="footer">
			...
			<div>
				<div id="page" class="pagination hid">
						<form action="<%=basePath%>collateralizationApplyController.do?method=elecModifyApplyBatchList" name="pageForm" method="post">
