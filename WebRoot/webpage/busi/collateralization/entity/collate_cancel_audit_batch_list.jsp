...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
			    <form action="<%=basePath%>collateralizationAuditController.do?method=cancelAuditBatchList" method="post" id="page-content" name="Form" style="padding:0px;" class="form-search">
					<%-- 查询区  --%>
					<div class="row-fluid">
			...
			<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>collateralizationAuditController.do?method=cancelAuditBatchList"  name="pageForm" method="post">
...
<script>
	...
	function cancelAudit(){
	     ...
	     dataCollectForm.action = "<%=basePath%>collateralizationAuditController.do?method=cancelAuditBillList"
