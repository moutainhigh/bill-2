...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
			    <form action="<%=basePath%>collateralizationStorageController.do?method=storageBatchList"  method="post" id="page-content" name="Form" style="padding:0px;" class="form-search">
					<%-- 查询区  --%>
					<div class="row-fluid">
        ...
        <div id="footer">
			...
			<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>collateralizationStorageController.do?method=storageBatchList"  name="pageForm" method="post">
...
<script>
	...
	function seachWaitStorageBill(){
	     ...
	     dataCollectForm.action = "<%=basePath%>collateralizationStorageController.do?method=storageBillList"
	     dataCollectForm.submit();
	 //  	 location.href="<%=basePath%>collateralizationStorageController.do?method=storageBillList&saveId="+saveId;
	}
	//批次详情
