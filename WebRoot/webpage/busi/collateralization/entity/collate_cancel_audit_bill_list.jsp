		...
		<div id="page-content" class="page-content">
			...
			<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>collateralizationAuditController.do?method=cancelAuditBillList"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
        ...
        dataCollectForm.action="<%=basePath%>collateralizationAuditController.do?method=cancelAuditBatchList";
	...
	function cancelAudit(){
		...
		modal("#layer_loading,#image");//点击票据管理按钮，弹出‘加载中’的遮罩层
		$.ajax({
			url:"<%=basePath%>collateralizationAuditController.do?method=cancelAudit",
			type:"POST",
			data:{"ids":ids},
			dataType:"json",
			success:function(rs){
