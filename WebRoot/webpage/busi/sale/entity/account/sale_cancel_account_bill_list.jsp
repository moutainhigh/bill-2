...
<script>
	...
	function cancelAcct(){
		...
		dataCollectForm.action = "<%=basePath%>saleAccountController.do?method=cancelAccount";
		dataCollectForm.submit();
	}
	function goBack(){
		modal("#layer_loading,#image");//点击票据管理按钮，弹出‘加载中’的遮罩层
		dataCollectForm.action="<%=basePath%>saleAccountController.do?method=cancelAccountBatchList";
		dataCollectForm.submit();
	}	
	//详情页面
