				...
				<form id="btnForm">
					<div class="row-fluid">
						<div class="span6" id="btn-left">
							<a class="btn-mini pull-left" onclick="billManage();">下一步</a> 
						</div>
					</div>
				</form>
			</div>
				...
				<table class="table table-striped table-bordered table-hover" id="tab" cellpadding="0" cellspacing="0">
				 ...
				 <div>
					<div id="page" class="pagination">
							<form action="<%=basePath%>saleAccountController.do?method=cancelAccountBatchList"  name="pageForm" method="post">
...
<script>
	function billManage(){
		...
		dataCollectForm.action = "<%=basePath%>saleAccountController.do?method=cancelAccountBillManage";
