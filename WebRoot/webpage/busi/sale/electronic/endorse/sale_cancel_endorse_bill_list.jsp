<%-- 
 * 文件名称: sale_cancel_endorse_bill_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 待审核批次的票据清单列表页面
	...
	<div class="clearfix">
		<div id="page-content" class="page-content">
				...
				<form id="btnForm" name="btnForm" action="<%=basePath%>saleEndorseController.do?method=auditList" method="post">
					<div class="row-fluid">
						...
						<div class="span6" id="btn-right">
							<a class="btn-mini pull-right" onclick="cancelEndorse();">确认</a>
			...
			<div id="page" class="pagination">
				<form action="<%=basePath%>saleEndorseController.do?method=queryCancelBillList"
...
<script>
	...
	function goHistory(){
		...
		dataCollectForm.action = "<%=basePath%>saleEndorseController.do?method=queryForCancelSaleEndorse";
	...
	function cancelEndorse(){
		...
		modal("#layer_loading,#image");//点击票据管理按钮，弹出‘加载中’的遮罩层
		dataCollectForm.action="<%=basePath%>saleEndorseController.do?method=cancelElecSaleEndorse";
		dataCollectForm.submit();
	}
</script>
</body>
