...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
			    <form action="<%=basePath%>repurCollateStorageController.do?method=storageBatchList"  method="post" id="page-content" name="Form" style="padding:0px;" class="form-search">
					<%-- 查询区  --%>
					<div class="row-fluid">
        	...
        	<div id="footer">
				...
				<div>
					<div id="page" class="pagination">
							<form action="<%=basePath%>repurCollateStorageController.do?method=storageBatchList"  name="pageForm" method="post">
...
<script>
	...
	function seachWaitStorageBill(){
	     ...
	     dataCollectForm.action = "<%=basePath%>repurCollateStorageController.do?method=storageBillList"
	     dataCollectForm.submit();
	 //  	 location.href="<%=basePath%>repurCollateStorageController.do?method=storageBillList&getId="+getId;
	}
	//批次详情
