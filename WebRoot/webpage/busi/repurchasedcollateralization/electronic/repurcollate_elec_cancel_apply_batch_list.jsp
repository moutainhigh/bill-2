<%-- 
 * 文件名称: repurcollate_elec_cancel_apply_apply_batch_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
...
<div class="clearfix">
	<div id="page-content" class="page-content">
		<div id="header">
			<form action="<%=basePath%>repurCollateApplyController.do?method=elecCancelApplyBatchList"  method="post" id="page-content" name="Form" style="padding:0px;" class="form-search">
		   	<%-- 查询区  --%>
				<div class="row-fluid">
		...
		<form action="#" name="dataCollectForm" method="post"></form>
		 ...
		 <div>
			<div id="page" class="pagination">
					<form action="<%=basePath%>repurCollateApplyController.do?method=elecCancelApplyBatchList"  name="pageForm" method="post">
...
<script>
	...
	function cancelApply(){
	     ...
	     dataCollectForm.action = "<%=basePath%>repurCollateApplyController.do?method=elecCancelApplyBillList"
