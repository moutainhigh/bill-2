...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
				<form action="<%=basePath%>outApplyController.do?method=searchBatch"  method="post" name="custForm" id="custForm" class="form-search">
					<%-- 查询区  --%>
					<div class="row-fluid">
						<label for="custNo"><span class="star">*</span>客户号</label>
						...
						<label for="custName"><span class="star">*</span>客户名称</label>
		     ...
		     <div id="footer">
						...
						<c:choose>
								<c:when test="${not empty resultList}">
									<c:forEach items="${resultList}" var="batchList" varStatus="vs">
										<tr>
											<%--<td class="center">
												<label><input type='checkbox' name='intoId' value="${batchList.intoId}" /><span class="lbl"></span></label>
											</td>--%>
											<td class="center">
											<label><input type="checkbox" onclick="radioStyle(this,'intoId')" name="intoId" value="${batchList.intoId}"/><span class="lbl"></span></label>
											</td>
				...
				<div>
					<div id="page" class="pagination hid">
						<form action="<%=basePath%>outApplyController.do?method=searchBatch" name="pageForm" method="post">
...
<script>
	...
	function billManage(){
	     ...
	     dataCollectForm.action = "<%=basePath%>outApplyController.do?method=billManage"
