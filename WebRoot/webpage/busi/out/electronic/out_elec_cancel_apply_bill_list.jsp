<%-- 
 * 文件名称: out_elec_cancel_apply_bill_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
		...
		<div id="page-content" class="page-content">
			...
			<div>
				<div id="page" class="pagination">
						<form action="<%=basePath%>outApplyController.do?method=elecCancelApplyBillList"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
        ...
        dataCollectForm.action="<%=basePath%>outApplyController.do?method=elecCancelApplyBatchList";
	...
	function cancelApply(){
		...
		$.ajax({
			url:"<%=basePath%>outApplyController.do?method=elecCancelApply",
			type:"POST",
