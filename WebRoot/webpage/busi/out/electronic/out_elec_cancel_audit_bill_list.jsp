<%-- 
 * 文件名称: out_elec_cancel_audit_bill_list.jsp.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
	...
	<div class="clearfix">
			...
			<div id="header">
				<form action=""	method="post" name="userForm" id="userForm" class="form-search detail-form">
					<div class="row-fluid">
						...
						<label for="batchType" >批次<span style="margin:0 5.5px;"></span>类型</label>
		...
		<div>
			<div id="page" class="pagination">
					<form action="<%=basePath%>outAuditController.do?method=elecCancelAuditBillList"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
        ...
        dataCollectForm.action="<%=basePath%>outAuditController.do?method=elecCancelAuditBatchList";
	...
	function cancelAudit(){
		...
		$.ajax({
			url:"<%=basePath%>outAuditController.do?method=elecCancelAudit",
			type:"POST",
			data:{"ids":ids},
			dataType:"json",
			success:function(rs){
