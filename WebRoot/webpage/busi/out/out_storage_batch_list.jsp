...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
			    <form action="<%=basePath%>outStorageController.do?method=storageBatchList"  method="post" id="page-content" name="Form" style="padding:0px;" class="form-search">
					<%-- 查询区  --%>
					<div class="row-fluid">
        	...
        	<div id="footer">
				...
				<div>
					<div id="page" class="pagination">
							<form action="<%=basePath%>outStorageController.do?method=storageBatchList"  name="pageForm" method="post">
...
<script>
	...
	function seachWaitStorageBill(){
	     ...
	     dataCollectForm.action = "<%=basePath%>outStorageController.do?method=storageBillList"
	     dataCollectForm.submit();
	 //  	 location.href="<%=basePath%>outStorageController.do?method=storageBillList&outId="+outId;
	}
	//批次详情
