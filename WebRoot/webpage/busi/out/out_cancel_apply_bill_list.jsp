<%-- 
 * 文件名称: out_cancel_apply_bill_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
		...
		<div id="page-content" class="page-content">
			...
			<div>
				<div id="page" class="pagination">
						<form action="<%=basePath%>outApplyController.do?method=cancelApplyBillList"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
        ...
        dataCollectForm.action="<%=basePath%>outApplyController.do?method=cancelApplyBatchList";
	...
	function cancelApply(){
		...
		modal("#layer_loading,#image");//点击票据管理按钮，弹出‘加载中’的遮罩层
		$.ajax({
			url:"<%=basePath%>outApplyController.do?method=cancelApply",
			type:"POST",
			data:{"ids":ids,"outId":outId},
			dataType:"json",
			success:function(rs){
				if(rs.success){
					dataCollectForm.action = "<%=basePath%>outApplyController.do?method=cancelApplyBatchList";
