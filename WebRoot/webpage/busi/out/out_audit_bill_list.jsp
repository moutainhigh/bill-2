	...
	<div class="clearfix">
		...
		<div>
			<div id="page" class="pagination">
					<form action="<%=basePath%>outAuditController.do?method=auditBillList"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
        ...
        dataCollectForm.action="<%=basePath%>outAuditController.do?method=auditBatchList";
	...
	function audit(){
		...
		var outId = '${batch.outId}';
		 ...
		 diag.Drag = true;
		 diag.Title ="审核";
		 diag.URL = "<%=basePath%>outAuditController.do?method=toAudit&ids="+ids+"&outId="+outId;
		 diag.Width = 430;
		 diag.Height =270;
		 diag.CancelEvent = function(){ //关闭事件
	        ...
	        dataCollectForm.action = "<%=basePath%>outAuditController.do?method=auditBatchList"
	        dataCollectForm.submit();
		//	location.href ="<%=basePath%>outAuditController.do?method=auditBatchList";
		 };
		 diag.show();
	}
	//详情页面
