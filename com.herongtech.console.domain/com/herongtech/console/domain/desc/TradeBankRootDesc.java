...
public class TradeBankRootDesc implements IBeanDesc {
	private Map<String,FieldDesc> fieldDescMap=new HashMap<String,FieldDesc>();
	public TradeBankRootDesc(){
FieldDesc  fieldDesc=null;
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("leftThreeBankNo");
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("bankName");
 fieldDesc.setType("String");
