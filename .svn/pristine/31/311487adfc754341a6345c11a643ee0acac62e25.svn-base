...
public class Var130003Result {
    ...
    private List<Var130003InfoBean> result;
	...
	public List<Var130003InfoBean> getResult() {
		return result;
	}
	public void setResult(List<Var130003InfoBean> result) {
		this.result = result;
	}
