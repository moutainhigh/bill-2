...
<div id="page-content" class="page-content">
	<form action="<%=basePath%>subcollStorageController.do?method=elecSendBatchManage"  method="post" name="infoForm" id="infoForm" class="form-search">
	</form>
		<div class="row-fluid">
			<div id="center">
				<form  id="btnForm">
	...
	<form  action="#" name="dataCollectForm" method="post"></form>
	 <div>
		<div id="page" class="pagination">
			<form action="<%=basePath%>subcollStorageController.do?method=elecSendBatchManage"  name="pageForm" method="post">
