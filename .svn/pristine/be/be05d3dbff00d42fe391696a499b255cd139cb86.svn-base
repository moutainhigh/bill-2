...
public class TaskPool{
	private String taskNo = " ";	//作业编号
	private String taskName = " ";	//task_name
	private String parentTaskNo = " ";	//parent_task_no
	private String taskType = " ";	//作业类型
	private String repeatFlag = " ";	//允许重复执行
	private String delayFlag = " ";	//延时标志
	private String delayTime = " ";	//延时时间
	private String dealStatus = " ";	//处理状态
	private String dealMsg = " ";	//处理信息
	private String operNo = " ";	//操作员编号
	private String repeatNum = " ";	//操作次数
