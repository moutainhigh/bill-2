...
<div class="clearfix">
	<div id="jump-content" class="page-content">
		<form action="<%=basePath%>intoAuditController.do?method=audit" method="post" name="Form" id="Form" class="form-search">
			<div class="row-fluid">
	...
	function save(){
		if($("#Form").valid()){
			...
			modal("#layer_loading,#image");
				$.ajax({
					url:"<%=basePath%>intoAuditController.do?method=audit",
					type:"POST",
					data:$("#Form").serialize(),
					dataType:"json",
					success:function(rs){
