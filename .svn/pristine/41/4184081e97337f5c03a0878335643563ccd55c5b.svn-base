...
public class Var107004Result {
    ...
    private List<Var107004InfoBean> result;
	...
	public List<Var107004InfoBean> getResult() {
		return result;
	}
	public void setResult(List<Var107004InfoBean> result) {
		this.result = result;
	}
