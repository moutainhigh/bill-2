<%-- 
 * 文件名称: revoke_rebuy_bill_audit.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
		...
		<div id="page-content" class="page-content">
				...
				<form  id="btnForm">
					<div class="row-fluid">
						...
						<div class="span6" id="btn-right">
							<a class="btn-mini pull-right" href="javascript:revokeAudit();">撤销审核</a>
			...
			<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>rebuyAuditController.do?method=searchRevokableDetail"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
		...
		dataCollectForm.action = "<%=basePath%>rebuyAuditController.do?method=searchRevokableBatch";
	...
	function revokeAudit(){
		...
		dataCollectForm.action = "<%=basePath%>rebuyAuditController.do?method=revokeAudit";
		dataCollectForm.submit();
	}
</script>
</body>
