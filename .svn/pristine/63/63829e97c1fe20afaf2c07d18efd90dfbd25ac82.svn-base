	...
	<div class="clearfix">
		<div id="page-content" class="page-content">
				...
				<form id="btnForm" name="btnForm" action="<%=basePath%>SaleBackAuditController.do?method=auditbilllist" method="post">
					<div class="row-fluid">
						...
						<div class="span6" id="btn-right"> 
							<a class="btn-mini pull-right" onclick="toAudit();">记账</a>
			...
			<div id="page" class="pagination">
				<form action="<%=basePath%>salebackAccountController.do?method=entitySalebackaccountbill" name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
		...
		dataCollectForm.action = "<%=basePath%>salebackAccountController.do?method=entitySalebackaccountBatch";
	...
	function toAudit(){
		...
		dataCollectForm.action = "<%=basePath%>salebackAccountController.do?method=entitySalebackaccount";
		dataCollectForm.submit();
	}
	//详情页面
