<%-- 
 * 文件名称: buyback_account_batch_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
		...
		<div id="page-content" class="page-content">
			...
			<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>buybackAccountController.do?method=entityAccountBatchList" method="post" name="pageForm">
...
<script>
	...
	function billManage(){
		...
		pageForm.action = "<%=basePath%>buybackAccountController.do?method=accountBillList";
		pageForm.submit();
	}
	//批次详情页面
