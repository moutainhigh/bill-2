		    ...
		    <div id="footer">
		 	...
		 	<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>rebuyAuditController.do?method=searchRevokableBatch"  name="pageForm" method="post">
...
<script>
	function searchRevokableDetail(rebuyId){
		...
		dataCollectForm.action = "<%=basePath%>rebuyAuditController.do?method=searchRevokableDetail";
