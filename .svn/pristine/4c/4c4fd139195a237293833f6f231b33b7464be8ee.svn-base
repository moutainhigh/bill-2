<%-- 
 * 文件名称: rebuy_acct_batch_elec.jsp
 * 系统名称: 票据管理平台
 * 模块名称: 电票转入记账
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
			...
			<div id="center">
				<div class="row-fluid">
					<div class="span6" id="btn-left" >
						<a class="btn-mini" href="javascript:reauditDetailList();">下一步</a>
					</div>
			...
			<form  action="#" name="dataCollectForm" method="post"></form>
			 ...
			 <div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>rebuyAccountController.do?method=listAccountElec"  name="pageForm" method="post">
...
<script>
	function reauditDetailList(rebuyId){
		...
		dataCollectForm.action = "<%=basePath%>rebuyAccountController.do?method=elecreauditDetailList";
