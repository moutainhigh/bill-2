	...
	<div class="clearfix">
		<div id="page-content" class="page-content">
			...
			<div id="page" class="pagination">
				<form action="<%=basePath%>buybackAccountController.do?method=buybackApplyAccountList"  name="pageForm" method="post">
...
<script>
	function reviewList(){
		...
		pageForm.action="<%=basePath%>buybackAccountController.do?method=buybackApplyAccountDetailList";
		pageForm.submit();
	}
</script>
</body>
