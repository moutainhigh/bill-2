...
public class BuybackBillBean {
	...
	private Double buybackMoney;//实收金额
	private String buybackMoneyString;
	...
	public String getBuybackMoneyString() {
		return buybackMoneyString;
	}
	public void setBuybackMoneyString(String buybackMoneyString) {
		this.buybackMoneyString = buybackMoneyString;
	}
}
