...
public class Var120003Result {
    ...
    private List<Var120003InfoBean> result;
	...
	public List<Var120003InfoBean> getResult() {
		return result;
	}
	public void setResult(List<Var120003InfoBean> result) {
		this.result = result;
	}
