			...
			<div id="center">
					<div class="row-fluid">
						...
						<div class="span6" id="btn-right">
							<a class="btn-mini pull-right" href="javascript:applyAccount();">申请记账</a>
...
<script>
	...
	function goHistory(){
		...
		pageForm.action="<%=basePath%>buybackAccountController.do?method=buybackApplyAccountList";
		pageForm.submit();
	}
	function applyAccount(){
		...
		modal("#layer_loading,#image");//点击票据管理按钮，弹出‘加载中’的遮罩层
		pageForm.action="<%=basePath%>buybackAccountController.do?method=applyAccount";
		pageForm.submit();
	}
	//详情页面
