/********************************************
* 文件名称: RgctExceptionDraftDesc.java
* 系统名称: 合融基础技术平台V2.0
* 模块名称:
* 软件版权: 北京合融科技有限公司
* 功能说明: 
...
public class RgctExceptionDraftDesc implements IBeanDesc {
	private Map<String,FieldDesc> fieldDescMap=new HashMap<String,FieldDesc>();
	public RgctExceptionDraftDesc(){
FieldDesc  fieldDesc=null;
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("msgSid");
 fieldDesc.setType("String");
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("draftDatetime");
 fieldDesc.setType("String");
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("draftTxt");
 fieldDesc.setType("String");
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("orgnlMsgSid");
 fieldDesc.setType("String");
 fieldDesc.setLength(50);
 fieldDesc.setScale(0);
 fieldDescMap.put(fieldDesc.getBeanFileName(),fieldDesc);
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("orgnlDraftDatetime");
 fieldDesc.setType("String");
 fieldDesc.setLength(20);
 fieldDesc.setScale(0);
 fieldDescMap.put(fieldDesc.getBeanFileName(),fieldDesc);
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("orgnlDraftNo");
 fieldDesc.setType("String");
 fieldDesc.setLength(50);
 fieldDesc.setScale(0);
 fieldDescMap.put(fieldDesc.getBeanFileName(),fieldDesc);
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("orgnlDraftTxt");
 fieldDesc.setType("String");
 fieldDesc.setLength(256);
 fieldDesc.setScale(0);
 fieldDescMap.put(fieldDesc.getBeanFileName(),fieldDesc);
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("errCount");
