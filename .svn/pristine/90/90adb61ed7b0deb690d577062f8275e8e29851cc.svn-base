...
public class AuditStationDesc implements IBeanDesc {
	private Map<String,FieldDesc> fieldDescMap=new HashMap<String,FieldDesc>();
	public AuditStationDesc(){
FieldDesc  fieldDesc=null;
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("anId");
 fieldDesc.setType("String");
 fieldDesc.setLength(30);
 fieldDesc.setScale(0);
 fieldDescMap.put(fieldDesc.getBeanFileName(),fieldDesc);
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("asName");
 fieldDesc.setType("String");
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("asPrivilege");
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("asRemark");
 fieldDesc.setType("String");
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("sortNo");
 fieldDesc.setType("String");
 fieldDesc.setLength(30);
 fieldDesc.setScale(0);
 fieldDescMap.put(fieldDesc.getBeanFileName(),fieldDesc);
