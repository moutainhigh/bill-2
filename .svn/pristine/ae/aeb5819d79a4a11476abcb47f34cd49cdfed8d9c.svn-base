<%-- 
 * 文件名称: collate_elec_audit_batch_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
			    <form action="<%=basePath%>collateralizationAuditController.do?method=elecAuditBatchList" method="post" id="page-content" name="Form" style="padding:0px;" class="form-search">
				<%-- 查询区  --%>
					<div class="row-fluid">
		    ...
		    <div id="footer">
				...
				<div>
					<div id="page" class="pagination">
						<form action="<%=basePath%>collateralizationAuditController.do?method=elecAuditBatchList"  name="pageForm" method="post">
...
<script>
	...
	function seachWaitAuditBill(){
	     ...
	     dataCollectForm.action = "<%=basePath%>collateralizationAuditController.do?method=elecAuditBillList"
