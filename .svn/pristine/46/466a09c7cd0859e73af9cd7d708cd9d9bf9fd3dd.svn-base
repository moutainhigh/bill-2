...
<div id="page-content" class="page-content">
	<div id="center">
		<div class="row-fluid" style="margin-bottom:0px;">
			<div class="span6" id="btn-left" >
				<%-- <a class="btn-mini" onclick="submitAll();">全款收回</a>
				<a class="btn-mini" onclick="submitPart();">部分收回</a>  --%>
	...
	<div>
		<div id="page" class="pagination">
			<form action="<%=basePath%>receiveMoneyController.do?method=elecSearchBillList"  name="pageForm" method="post">
