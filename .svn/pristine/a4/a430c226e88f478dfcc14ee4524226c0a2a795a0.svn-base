	...
	<div class="clearfix">
		...
		<div>
			<div id="page" class="pagination">
					<form action="<%=basePath%>collateralizationAuditController.do?method=auditBillList"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
        ...
        dataCollectForm.action="<%=basePath%>collateralizationAuditController.do?method=auditBatchList";
	...
	function audit(){
		...
		var saveId = '${batch.saveId}';
		 ...
		 diag.Drag = true;
		 diag.Title ="审核";
		 diag.URL = "<%=basePath%>collateralizationAuditController.do?method=toAudit&ids="+ids+"&saveId="+saveId;
		 diag.Width = 430;
		 diag.Height =270;
	...
	function printList(){
		...
		var ids = getCheckStr("ids");
		doPrint("addPrintController.do?method=doPrint&ids="+ids+"&moduleId=1110204&type=CollateralizationListPrint&baid="+batch_id+"&handleType=审 核"); 	 
