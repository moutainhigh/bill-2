<%-- 
 * 文件名称: modify_rebuy_apply_batch_elec.jsp
 * 系统名称: 票据管理平台
 * 模块名称: 电票转入修改申请批次页面
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
		...
		<form  action="#" name="dataCollectForm" method="post"></form>
		 ...
		 <div>
			<div id="page" class="pagination">
				<form action="<%=basePath%>rebuyApplyController.do?method=searchEditableApplyBatchElec"  name="pageForm" method="post">
...
<script>
	function nextStep(rebuyId){
		...
		dataCollectForm.action = "<%=basePath%>rebuyApplyController.do?method=toModifyPage";
