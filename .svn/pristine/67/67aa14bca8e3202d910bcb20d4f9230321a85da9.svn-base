...
<div id="page-content" class="page-content">
	...
	<form action="<%=basePath%>receiveMoneyController.do?method=elecSearchBillList"  method="post" id="" name="custForm" style="margin-bottom:0px;" class="form-search">
		<div class="row-fluid" style="margin-bottom:0px;">
			<div class="span6"  id="btn-left">
			</div>
			<div class="span6" id="btn-right">
				<a class="btn-mini pull-right" onclick="submitacct();">
				<%-- <i class="icon-circle-arrow-right"></i> --%>提交记账</a>
	...
	<%-- <div>
		<div id="page" class="pagination">
			<form action="<%=basePath%>receiveMoneyController.do?method=toSubmitAccount"  name="pageForm" method="post">
...
<script>
	...
	function goBack(){
		modal("#layer_loading,#image");//点击票据管理按钮，弹出‘加载中’的遮罩层
		dataCollectForm.action = "<%=basePath%>receiveMoneyController.do?method=elecSearchBillList";
		dataCollectForm.submit();
	}
	//详情页面
