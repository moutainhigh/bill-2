		...
		<div id="page-content" class="page-content">
			...
			<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>SalebackApplyController.do?method=toApplyDetailPagetwo" method="post" name="pageForm">
						<%@ include file="/webpage/system/admin/pageFormContent.jsp"%> 
						
						<input type="hidden" name="rebuyId" id="rebuyId" value="${rebuyId}" />
						<input type="hidden" name="salebackId" id="salebackId" value="${salebackId}" />
