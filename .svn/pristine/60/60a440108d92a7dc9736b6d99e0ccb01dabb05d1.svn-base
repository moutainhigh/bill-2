/********************************************
* 文件名称: DayDetailRespInfoDesc.java
* 系统名称: 合融基础技术平台V2.0
* 模块名称:
* 软件版权: 北京合融科技有限公司
* 功能说明: 
...
public class DayDetailRespInfoDesc implements IBeanDesc {
	private Map<String,FieldDesc> fieldDescMap=new HashMap<String,FieldDesc>();
	public DayDetailRespInfoDesc(){
FieldDesc  fieldDesc=null;
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("checkDt");
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("draftHead");
 fieldDesc.setType("String");
 fieldDesc.setLength(0);
 fieldDesc.setScale(0);
 fieldDescMap.put(fieldDesc.getBeanFileName(),fieldDesc);
