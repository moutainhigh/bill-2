...
<div class="clearfix">
		<div id="page-content" class="page-content">
			...
			<%-- 按钮操作区 --%>
			<div id="center">
				<form action="<%=basePath%>outApplyController.do?method=applyBillList"  method="post" id="elecReviewForm" name="elecReviewForm" style="padding:0px;margin-bottom:0px;" class="form-search">
					<div class="row-fluid">
			...
			<div id="page" class="pagination">
					<form action="<%=basePath%>outApplyController.do?method=applyBillList"  name="pageForm" method="post" >
...
<script>
	...
	function goHistory(){
	    ...
	    dataCollectForm.action="<%=basePath%>outApplyController.do?method=searchBatch";
	...
	function apply(custNo,custName){
		...
		$.ajax({
			url:"<%=basePath%>outApplyController.do?method=apply",
			type:"POST",
