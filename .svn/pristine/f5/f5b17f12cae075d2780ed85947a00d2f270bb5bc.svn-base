...
import com.herongtech.online.trans.trans103101.Var103101InfoBean;
...
public class Var103001 {
	...
	private List<Var103001InfoBean> result;
	...
	public List<Var103001InfoBean> getResult() {
		return result;
	}

	public void setResult(List<Var103001InfoBean> result) {
		this.result = result;
	}
