<%-- 
 * 文件名称:out_elec_audit_btch_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
			    <form action="<%=basePath%>outAuditController.do?method=elecAuditBatchList" method="post" id="page-content" name="Form" style="padding:0px;" class="form-search">
					<%-- 查询区  --%>
					<div class="row-fluid">
				...
				<form  id="btnForm">
					<div class="row-fluid">
						<div class="span6" id="btn-left" >
							<a class="btn-mini" href="javascript:seachWaitAuditBill();">下一步</a>
					   </div>
				...
				<form action="#" name="dataCollectForm" method="post"></form>
				 ...
				 <div>
					<div id="page" class="pagination">
						<form action="<%=basePath%>outAuditController.do?method=elecAuditBatchList"  name="pageForm" method="post">
...
<script>
	...
	function seachWaitAuditBill(){
	     ...
	     dataCollectForm.action = "<%=basePath%>outAuditController.do?method=elecAuditBillList"
	     dataCollectForm.submit();
	   //	 location.href="<%=basePath%>outAuditController.do?method=elecAuditBillList&outId="+outId;
	}
	//批次详情
