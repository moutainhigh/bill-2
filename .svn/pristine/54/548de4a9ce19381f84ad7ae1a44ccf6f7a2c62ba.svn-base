...
eye.datePicker = function() {
    ...
    style[14] = 'width: 24px; height: 20px; float: left; text-align: center; font-family: Tahoma; font-size: 12px; color: #15428B; line-height: 20px; background-color: #DFE8F6;';
    style[15] = 'width: 26px; height: 18px; float: left; text-align: center; font-family: Tahoma; font-size: 11px; color: #000000; line-height: 18px; background-color: #FFFFFF; border: solid 1px #FFFFFF; cursor: pointer;';
