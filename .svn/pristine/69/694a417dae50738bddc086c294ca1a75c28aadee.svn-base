...
<body>
	<div class="clearfix">
		<div class="page-content" id="jump-content">
			...
			<div class="row-fluid" >
				<label for="delayType" class="text-right"><span class="star">*</span>请选顺延规则</label>
				<t:dictSelect valid="required" name="delayType" className="input-medium" other="" dictGroup="K_ELEC_DELAYTYPE" haveHead="true" defaultVal="0" title="顺延规则" >
				</t:dictSelect>
			</div>
