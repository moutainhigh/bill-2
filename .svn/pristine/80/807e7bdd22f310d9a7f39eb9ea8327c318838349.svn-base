...
<div class="clearfix">
	<div id="page-content" class="page-content">
	    <form action="<%=basePath%>acptAccountController.do?method=elecDueCharge"  method="post" name="dataCollectForm" id="dataCollectForm" class="form-search" >
	    <%-- 按钮操作区 --%>
			<div id="center">
				<form  id="btnForm">
					<div class="row-fluid">
		...
		<div>
			...
			<div id="page" class="pagination">
				<form action="<%=basePath%>acptAccountController.do?method=elecDueCharge"  name="pageForm" method="post">
...
<script>
    function elecBillManage(){
		...
		dataCollectForm.action = "<%=basePath%>acptAccountController.do?method=elecDueChargeBill";
