...
<div id="center">
	<form action="<%=basePath%>subcollApplyController.do?method=elecRevokeBatchManage"  method="post" name="infoForm" id="infoForm" class="form-search">
		<%-- 按钮操作区 --%>
		<div class="row-fluid">
	...
	<div>
		<div id="page" class="pagination">
			<form action="<%=basePath%>subcollApplyController.do?method=elecRevokeBatchManage"  name="pageForm" method="post">
...
<script>
	...
	function billManage(){
		...
		dataCollectForm.action = "<%=basePath%>subcollApplyController.do?method=revokeBillDetailsManage";
