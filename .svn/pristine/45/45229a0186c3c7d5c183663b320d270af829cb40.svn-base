<%-- 
 * 文件名称: repurcollate_elec_cancel_apply_bill_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
			...
			<div id="header">
				...
				<div>
					<div id="page" class="pagination">
							<form action="<%=basePath%>repurCollateApplyController.do?method=elecCancelApplyBillList"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
        ...
        dataCollectForm.action="<%=basePath%>repurCollateApplyController.do?method=elecCancelApplyBatchList";
	...
	function cancelApply(){
		...
		$.ajax({
			url:"<%=basePath%>repurCollateApplyController.do?method=elecCancelApply",
			type:"POST",
