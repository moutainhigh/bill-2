<%-- 
 * 文件名称: sale_cancel_apply_batch_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 批次列表页面
	...
	<div class="clearfix">
		<div id="page-content" class="page-content">
			...
			<div id="page" class="pagination">
				<form action="<%=basePath%>saleApplyController.do?method=cancelElecBatch"
...
<script>
	...
	function billManage(){
		...
		dataCollectForm.action = "<%=basePath%>saleApplyController.do?method=cancelApplyBillManage";
	...
	function goApplyInfo(saleId){
		 ...
		 diag.Drag = true;
		 diag.Title ="详情";
		 diag.URL = '<%=basePath%>saleApplyController.do?method=goApplyInfo&saleId='+saleId+'&flag=elecCancelApply';
		 diag.Width = 1000;
		 diag.Height = 505;
