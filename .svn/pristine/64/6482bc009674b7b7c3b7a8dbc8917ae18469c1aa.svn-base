<%-- 
 * 文件名称: elec_collate_audit_bill_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
		...
		<div id="page-content" class="page-content">
			...
			<div>
				<div id="page" class="pagination">
						<form action="<%=basePath%>collateralizationAuditController.do?method=elecAuditBillList"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
        ...
        dataCollectForm.action="<%=basePath%>collateralizationAuditController.do?method=elecAuditBatchList";
	...
	function audit(){
		...
		var saveId = '${batch.saveId}';
		 ...
		 diag.Drag = true;
		 diag.Title ="审核";
		 diag.URL = "<%=basePath%>collateralizationAuditController.do?method=toElecAudit&ids="+ids+"&saveId="+saveId;
		 diag.Width = 430;
		 diag.Height =180;
