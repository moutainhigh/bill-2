<%-- 
 * 文件名称: rebuy_batch_acct_entity.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
				...
				<table class="table table-striped table-bordered table-hover" id="tab" cellpadding="0" cellspacing="0">
				 ...
				 <div>
					<div id="page" class="pagination">
						<form action="<%=basePath%>rebuyAccountController.do?method=listAccountEntity"  name="pageForm" method="post">
...
<script>
	function reauditDetailList(rebuyId){
		...
		dataCollectForm.action = "<%=basePath%>rebuyAccountController.do?method=reauditDetailList";
