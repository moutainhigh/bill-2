...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
				<form action="<%=basePath%>intoApplyController.do?method=elecCancelApplyBatchList"  method="post" id="page-content" name="Form" style="padding:0px;" class="form-search">
			   		<%-- 查询区  --%>
					<div class="row-fluid">
    		...
    		<div id="footer">
			 ...
			 <div>
				<div id="page" class="pagination">
						<form action="<%=basePath%>intoApplyController.do?method=elecCancelApplyBatchList"  name="pageForm" method="post">
...
<script>
	...
	function cancelApply(){
	     ...
	     dataCollectForm.action = "<%=basePath%>intoApplyController.do?method=elecCancelApplyBillList"
