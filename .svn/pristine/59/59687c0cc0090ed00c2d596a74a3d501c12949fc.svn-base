...
<body style="font-family:'微软雅黑';">
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="center">
				<form action="<%=basePath%>subcollApplyController.do?method=revokeBatchManage"  method="post" name="infoForm" id="infoForm" class="form-search">
					<%-- 按钮操作区 --%>
					<div class="row-fluid">
		    ...
		    <div id="footer">
				...
				<div>
					<div id="page" class="pagination">
						<form action="<%=basePath%>subcollApplyController.do?method=revokeBatchManage"  name="pageForm" method="post">
