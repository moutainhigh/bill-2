<%-- 
 * 文件名称: rebuy_batch_audit_entity.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
		    ...
		    <div id="footer">
			 ...
			 <div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>rebuyAuditController.do?method=listAuditEntity"  name="pageForm" method="post">
...
<script>
	function auditDetailList(rebuyId){
		...
		dataCollectForm.action = "<%=basePath%>rebuyAuditController.do?method=auditDetailList";
