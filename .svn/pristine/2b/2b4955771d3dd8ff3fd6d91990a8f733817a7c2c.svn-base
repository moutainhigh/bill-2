 ...
 * 修改记录: 修改日期    修改人员    修改说明
 *********************************************/
package com.herongtech.online.trans.trans100001;
 ...
 *
 */
public class T100001Service extends OnlineBaseService {
	...
	protected void action(Context context) throws Exception {
		Var100001 transVar = new Var100001();
	 ...
	 */
	protected void CheckData(Context context, Var100001 transVar) throws BizAppException{
	 ...
	 * @throws BizAppException
	 */
    protected void ToLocal(Context context, Var100001 transVar) throws BizAppException {
     ...
     * @throws BizAppException
     */
    protected void PackAnswer(Context context, Var100001 TransVar) throws BizAppException{
    	IData request = (IData)ContextUtil.getRequestData(context);
