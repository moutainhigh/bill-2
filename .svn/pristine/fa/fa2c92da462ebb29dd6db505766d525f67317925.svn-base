<%-- 
 * 文件名称: out_elec_apply_batch_list.jsp
 * 系统名称: 票据管理平台
 * 模块名称:
 * 软件版权: 北京合融科技有限公司
 * 功能说明: 
...
<body>
	<div class="clearfix">
		<div id="page-content" class="page-content">
			<div id="header">
				<form action="<%=basePath%>outApplyController.do?method=elecSearchBatch"  method="post" name="custForm" id="custForm" class="form-search">
					<%-- 查询区  --%>
					<div class="row-fluid">
		     ...
		     <div id="footer">
				...
				<div>
					<div id="page" class="pagination hid">
						<form action="<%=basePath%>outApplyController.do?method=elecSearchBatch" name="pageForm" method="post">
...
<script>
	...
	function billManage(){
	     ...
	     dataCollectForm.action = "<%=basePath%>outApplyController.do?method=elecBillManage"
