	...
	<div class="clearfix">
		<div id="page-content" class="page-content">
				...
				<form id="btnForm">
					<div class="row-fluid">
						<div class="span6" id="btn-left">
							<a class="btn-mini pull-left" href="javascript:billManage();">下一步</a> 
						</div>
					</div>
				</form>
			</div>
			...
			<div id="page" class="pagination">
				<form action="<%=basePath%>saleApplyController.do?method=cancelApplyBatchList"
...
<script>
	...
	function goApplyInfo(saleId){
		 ...
		 diag.Drag = true;
		 diag.Title ="详情";
		 diag.URL = '<%=basePath%>saleApplyController.do?method=goApplyInfo&saleId='+saleId+'&flag=cancelApply';
		 diag.Width = 1000;
		 diag.Height = 505;
