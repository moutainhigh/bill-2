...
public class RiskBillDesc implements IBeanDesc {
...
FieldDesc  fieldDesc=null;
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("description");
 fieldDesc.setType("String");
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("bill1");
 fieldDesc.setType("String");
 fieldDesc.setLength(20);
 fieldDesc.setScale(0);
 fieldDescMap.put(fieldDesc.getBeanFileName(),fieldDesc);
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("bill2");
 fieldDesc.setType("String");
 fieldDesc.setLength(20);
 fieldDesc.setScale(0);
 fieldDescMap.put(fieldDesc.getBeanFileName(),fieldDesc);
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("postdate");
 fieldDesc.setType("String");
 fieldDesc.setLength(20);
 fieldDesc.setScale(0);
 fieldDescMap.put(fieldDesc.getBeanFileName(),fieldDesc);
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("posttime");
 fieldDesc.setType("String");
 fieldDesc.setLength(20);
 fieldDesc.setScale(0);
 fieldDescMap.put(fieldDesc.getBeanFileName(),fieldDesc);
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("enterdate");
 fieldDesc.setType("String");
 fieldDesc.setLength(20);
 fieldDesc.setScale(0);
 fieldDescMap.put(fieldDesc.getBeanFileName(),fieldDesc);
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("entertime");
 fieldDesc.setType("String");
 fieldDesc.setLength(20);
 fieldDesc.setScale(0);
 fieldDescMap.put(fieldDesc.getBeanFileName(),fieldDesc);
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("urgeapplyname");
 fieldDesc.setType("String");
 fieldDesc.setLength(200);
 fieldDesc.setScale(0);
 fieldDescMap.put(fieldDesc.getBeanFileName(),fieldDesc);
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("courtname");
 fieldDesc.setType("String");
 fieldDesc.setLength(200);
 fieldDesc.setScale(0);
 fieldDescMap.put(fieldDesc.getBeanFileName(),fieldDesc);
 ...
 fieldDesc=new FieldDesc();
 fieldDesc.setBeanFileName("matchfileno");
 fieldDesc.setType("String");
