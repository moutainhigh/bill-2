		...
		<div id="page-content" class="page-content">
			...
			<div>
				<div id="page" class="pagination">
					<form action="<%=basePath%>collateralizationApplyController.do?method=elecCancelApplyBillList"  name="pageForm" method="post">
...
<script>
	...
	function goHistory(){
        ...
        dataCollectForm.action="<%=basePath%>collateralizationApplyController.do?method=elecCancelApplyBatchList";
	...
	function cancelApply(){
		...
		modal("#layer_loading,#image");//点击票据管理按钮，弹出‘加载中’的遮罩层
		$.ajax({
			url:"<%=basePath%>collateralizationApplyController.do?method=elecCancelApply",
			type:"POST",
