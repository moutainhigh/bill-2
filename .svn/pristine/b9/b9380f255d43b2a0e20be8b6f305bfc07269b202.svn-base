	...
	<div class="clearfix">
		<div id="page-content" class="page-content">
			...
			<div id="page" class="pagination">
				<form action="<%=basePath%>SaleBackAuditController.do?method=auditbilllist" name="pageForm" method="post">
...
<script>
	...
	function toAudit(){
		...
		var ids = getCheckStr("salemxId");
		 ...
		 diag.Drag = true;
		 diag.Title ="审核";
		 diag.URL = "<%=basePath%>SaleBackAuditController.do?method=toAudit&ids="+ids;
		 diag.Width = 430;
		 diag.Height =180;
