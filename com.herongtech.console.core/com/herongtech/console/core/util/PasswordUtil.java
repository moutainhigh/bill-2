...
public class PasswordUtil {
	...
	public static void main(String[] args) {
		...
		//com.herongtech.console.core.util.LogUtil.info("明文:" + str);
		//com.herongtech.console.core.util.LogUtil.info("密码:" + password);

		try {
			byte[] salt = PasswordUtil.getStaticSalt();
			String ciphertext = PasswordUtil.encrypt(userId, password, salt);
			System.out.println("密文"+ciphertext);
			//com.herongtech.console.core.util.LogUtil.info("密文:" + ciphertext);
			String plaintext = PasswordUtil.decrypt(ciphertext, password, salt);
			System.out.println("明文"+plaintext);
			//com.herongtech.console.core.util.LogUtil.info("明文:" + plaintext);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
