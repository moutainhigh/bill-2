...
/**
 * @author 李江涛
 *托收凭证打印类      根据tsubcoll_bill_info  的rgct_id查询出结果
 */
public class SubCollPzPrint extends AbstractPrint{
		...
		try{
			//ids为 发托清单的ids
				...
				for (int i = 0; i < id.length; i++) {
					SubcollBillInfo billInfo = service.getSubcollBillInfobyrgctid(id[i]);
